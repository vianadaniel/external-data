...
export class ExternalsController {
  ...
  @Post('farm-scraper/tjsp-eproc/consulta')
  async getTjspEprocConsulta(
    @Body() body: { fiscal_number: string },
  ): Promise<any> {
    return this.farmScraperService.getTjspEproc(body.fiscal_number);
  }
  ...
  async getSintegraTotalSefazMg(
    ...
    return this.sintegraTotalDataService.getSefazMgData(fiscal_number);
  }

  @Post('sintegra-total/sefaz-to')
  async getSintegraTotalSefazTo(
    @Body() body: { fiscal_number?: string },
  ): Promise<any> {
    const fiscal_number = body?.fiscal_number?.trim();
    if (!fiscal_number) {
    ...
    return this.sintegraTotalDataService.getSefazToData(fiscal_number);
  }
  ...
  async getSintegraTotalSefazMt(
    ...
    return this.sintegraTotalDataService.getSefazMtData(fiscal_number);
  }
  ...
  @Post('sintegra-total/sefaz-es')
  async getSintegraTotalSefazEs(
    @Body() body: { fiscal_number?: string },
  ): Promise<any> {
    const fiscal_number = body?.fiscal_number?.trim();
    if (!fiscal_number) {
  ...
  @Post('sintegra-total/sefaz-pe')
  async getSintegraTotalSefazPe(
    @Body() body: { fiscal_number?: string },
  ): Promise<any> {
    const fiscal_number = body?.fiscal_number?.trim();
    if (!fiscal_number) {
    ...
    return this.sintegraTotalDataService.getSefazPeData(fiscal_number);
  }

  @Post('sintegra-total/sefaz-pb')
  async getSintegraTotalSefazPb(
    @Body() body: { fiscal_number?: string },
  ): Promise<any> {
    const fiscal_number = body?.fiscal_number?.trim();
    if (!fiscal_number) {
